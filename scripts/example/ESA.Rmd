...
out <- run_scm(obj$community$parameters, collect = TRUE)
...
community <- regnans:::community_prepare_fitness(community)

community2 <- regnans:::community_prepare_approximate_fitness(community)

community3 <- regnans:::community_demography(community)

community3b <- regnans:::community_prepare_approximate_fitness(community3)
