...
### Can we use acquisition function to change the way Bayes Opt refines?
...
optimizer <- opt("mbo",
  loop_function = bayesopt_ego,
  surrogate = srlrn(lrn("regr.km", covtype = "exp", control = list(trace = FALSE))),
